 ...
 * ```
 */
export function encryptHybrid(data, publicKey) {
 ...
 * ```
 */
export function decryptHybrid(payload, privateKey) {
 ...
 * ```
 */
export function encryptFileData(data, publicKey) {
 ...
 * ```
 */
export function decryptFileData(payload, privateKey) {
