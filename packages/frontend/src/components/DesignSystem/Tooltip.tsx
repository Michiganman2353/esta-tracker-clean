 ...
 * - Dark themed tooltip with arrow
 * - Keyboard accessible (shows on focus)
 * - Mouse and touch support
 * - Maximum width constraint for long text
 * - TooltipIcon variant with info icon
 * 
 * Uses:
 * - React hooks for state and ref management
 * - Fixed positioning for portal-like behavior
 * - Tailwind CSS for styling
 * 
 * Best Practices:
 * - Use for supplementary information
 * - Keep tooltip content concise
 * - Ensure tooltip doesn't block important UI
 */
