...
function ToastItem({ toast, onClose }: ToastItemProps) {
  ...
  return (
    <div
      className={`
        ${colors[toast.type]}
        pointer-events-auto flex items-start gap-3 p-4 rounded-lg border-l-4 
        shadow-lg backdrop-blur-sm animate-slide-in-right max-w-md
      `}
      role="alert"
    >
      ...
      <button
        ...
        className="flex-shrink-0 text-current opacity-70 hover:opacity-100 transition-opacity focus:outline-none focus:ring-2 focus:ring-current rounded p-1"
